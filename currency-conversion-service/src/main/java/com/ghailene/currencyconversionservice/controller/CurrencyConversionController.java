package com.ghailene.currencyconversionservice.controller;

import com.ghailene.currencyconversionservice.entities.CurrencyConversion;
import com.ghailene.currencyconversionservice.configuration.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
    ...
    @GetMapping("/currency-conversion/from/{from}/to/{to}/quantity/{quantity}")
        ...
        // used for mapping from and to in currency exchange url
    ...
    /**
     * this one is using feign framework
     * @param from
     * @param to
     * @param quantity
     * @return
